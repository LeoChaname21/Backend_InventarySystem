...
public class OutcomeServiceImpl implements OutcomeService {
    ...
    private String createJGuia(Outcome outcome) {
        ...
        if(outcome.getEstado()){
            ...
            parameters.put("REPORT_AUTH",Paths.get("C:", "uploads","firmas",outcome.getUserAuth().getNombre()+".png") + File.separator);
        ...
        try {
            ...
            String ruta = Paths.get(Paths.get("C:", "uploads","orders").toString(), outcomeId + ".pdf").toString();
            createEmptyPDF(ruta);
